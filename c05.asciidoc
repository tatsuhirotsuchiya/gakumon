:imagesdir: https://github.com/tatsuhirotsuchiya/gakumon/tree/master/images
...
`ESC` を押しても画面が消えないなどの問題がある．

Windowsならコマンドプロンプトから "python ファイル名"，
Macならターミナルから"python3 ファイル名"として実行する方がよい．
...
信号機を完成させよう．
色は0～15で指定．
https://github.com/kitao/pyxel/blob/master/pyxel/examples/screenshots/05_color_palette.png[カラーパレット]
...
image::circletile.png

ランダムな円を敷き詰めよう．
時間があれば，色が背景とかぶらないようにしよう．
